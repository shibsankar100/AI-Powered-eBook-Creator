    ...
    <>
      ...
      <div className="relative h-[calc(100vh-68px)] overflow-hidden bg-[#f8f9fd]">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="signup-float-one absolute left-[8%] top-[25%] h-2 w-2 rounded-full bg-violet-300/60" />

          <div className="signup-float-two absolute right-[10%] top-[35%] h-2.5 w-2.5 rounded-full bg-indigo-300/60" />
        ...
        <main className="relative z-10 flex h-full items-center justify-center px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full max-w-5xl">
            ...
            <div className="grid items-center gap-8 lg:grid-cols-[1fr_400px]">
              ...
              <div className="signup-fade hidden lg:block">
                ...
                <div className="px-5">
                  ...
                  <p className="mt-4 max-w-md text-[15px] leading-6 text-slate-500">
                    ...
                    Build beautiful eBooks with AI-powered
                    writing tools, an intuitive editor, and
                    everything you need to bring your ideas
                    to life.
                  ...
                  <div className="relative mt-5 h-[190px]">
                    ...
                    <div className="signup-glow absolute left-16 top-12 h-36 w-36 rounded-full bg-violet-400/25 blur-3xl" />

                    <div className="signup-book absolute left-12 top-2">
                    ...
                    <div className="signup-float-one absolute left-44 top-0 rounded-xl border border-white/80 bg-white/90 p-2.5 shadow-lg backdrop-blur">
                    ...
                    <div className="signup-float-two absolute bottom-1 left-0 rounded-xl border border-white/80 bg-white/90 p-2.5 shadow-lg backdrop-blur">
              ...
              <div className="signup-scale w-full">
                ...
                <div className="mb-3 flex justify-center lg:hidden">
                  ...
                  >
                    ...
                    <div className="relative flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-600 text-white shadow-md shadow-violet-500/20">
                      ...
                      <Sparkles
                        size={9}
                        className="signup-sparkle absolute -right-1 -top-1 text-violet-300"
                      />
                  ...
                  <div className="p-5 sm:p-6">
                    ...
                    <div className="mb-4 text-center">
                      ...
                      <p className="mx-auto mt-1 max-w-xs text-[11px] leading-5 text-slate-500">
                        ...
                        Join AI eBook Creator and start
                        turning your ideas into books.
                    ...
                    >
                      ...
                      <div className="flex items-start gap-2 pt-0.5">
                        ...
                        <div className="mt-0.5 flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-violet-200 bg-violet-50">
                      ...
                      <div className="signup-button-group relative overflow-hidden rounded-lg pt-0.5">

                        <div className="signup-shimmer pointer-events-none z-20" />
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      ...
                      <div className="flex items-center gap-2 rounded-lg border border-slate-100 bg-slate-50/70 px-2.5 py-2">
                ...
                <div className="mt-2 flex justify-center">
                  ...
                  <Link
                    to="/"
                    className="signup-link text-[10px] font-bold text-slate-400 hover:text-violet-600"
                  >
                    ← Back to home
                  </Link>
